...
(() => {
    ...
    const I18N = {
        en: {
            ...
            tool_kind_risk: 'Risk analytics',
            tool_utm_tagline: 'Build consistent UTM URLs and validate the ones you already have.',
            tool_utm_text: 'Form with channel templates, live preview, and validation that catches missing params, spaces, casing and out-of-convention values. Bulk mode to generate many URLs at once from CSV. Local history, zero uploads.',
            tool_utm_cta: 'Open UTM Builder',
            ...
            tool_bank_text: 'Bet log, EV per entry, fractional Kelly Criterion, equity curve with drawdown, and risk alerts when a stake crosses 5% of bankroll or an entry has negative expected value. A discipline tool, not a tipster.',
            tool_bank_cta: 'Open Bankroll Tool',
        ...
        es: {
            ...
            tool_utm_text: 'Formulario con plantillas por canal, preview en vivo y validación que detecta params faltantes, espacios, mayúsculas y valores fuera de convención. Modo bulk para generar muchas URLs a la vez desde CSV. Historial local, cero uploads.',
            tool_utm_cta: 'Abrir UTM Builder',
            ...
            tool_bank_text: 'Log de apuestas, EV por operación, Kelly Criterion fraccionado, curva de equity con drawdown, y alertas de riesgo cuando el stake supera el 5% de la banca o una apuesta tiene valor esperado negativo. Herramienta de disciplina, no de tipster.',
            tool_bank_cta: 'Abrir Bankroll Tool',
            tool_bank_chip_ev: 'EV + Kelly',
