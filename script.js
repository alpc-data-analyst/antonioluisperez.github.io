...
(() => {
    ...
    const I18N = {
        en: {
            ...
            timeline_lead: 'Marketing to data, with detours that taught me very different things.',
            tl_uma_role: 'BA in Marketing and Market Research',
            tl_uma_text: 'Quantitative marketing foundation. First serious exposure to data analysis, consumer behaviour and applied business statistics.',
            tl_taco_text: 'Operations, scheduling, training and inventory. The real-world school of leadership, pressure and fast decision-making outside the textbook.',
            tl_windup_date: 'Sep 2024 → Apr 2025',
            tl_windup_role: 'Master in Digital Marketing + Digital Analytics Junior',
            tl_windup_text: '532h master in digital marketing. In parallel, my first analytics role: GA4 and GTM implementation and validation across client sites, dashboards, and tracking audits with Paid, SEO and CRO teams.',
            tl_paraty_date: 'Mar 2025 → Present',
            tl_paraty_text: 'End-to-end digital analytics. Reporting on GA4, Power BI, Looker Studio and BigQuery. Tracking implementation with GTM and DataLayer. Behaviour analysis with Hotjar and Clarity. Currently expanding into SQL and Python.',
            tl_bigschool_role: 'Master in Data Science and AI · 400h',
            tl_bigschool_text: 'The formal jump into Data Science. Machine Learning, Explainable AI, Python, SQL, Tableau and cloud analytics. The bridge from the analyst world to the scientist one.',
            tl_current: 'Current',
        ...
        es: {
            ...
            timeline_lead: 'De marketing a data, con paradas que me enseñaron cosas muy distintas.',
            tl_uma_role: 'Grado en Marketing e Investigación de Mercados',
            tl_uma_text: 'Base académica de marketing cuantitativo. Primera exposición seria a análisis de datos, comportamiento del consumidor y estadística aplicada al negocio.',
            tl_taco_text: 'Gestión de operaciones, turnos, formación e inventario. La escuela real de liderazgo, presión y toma de decisiones rápida fuera del papel.',
            tl_windup_date: 'Sep 2024 → Abr 2025',
            tl_windup_role: 'Máster en Marketing Digital + Digital Analytics Junior',
            tl_windup_text: '532h de máster en marketing digital. En paralelo, mi primer rol de analítica: implementación y validación de GA4 y GTM en webs de clientes, dashboards y auditorías de tracking con equipos de Paid, SEO y CRO.',
            tl_paraty_date: 'Mar 2025 → Actualmente',
            tl_paraty_text: 'Analítica digital end-to-end. Reporting en GA4, Power BI, Looker Studio y BigQuery. Implementación de tracking con GTM y DataLayer. Análisis de comportamiento con Hotjar y Clarity. Ampliando a SQL y Python.',
            tl_bigschool_role: 'Máster en Data Science e IA · 400h',
            tl_bigschool_text: 'El salto formal a Data Science. Machine Learning, Explainable AI, Python, SQL, Tableau y analítica en cloud. El puente entre el mundo del analyst y el del scientist.',
            tl_current: 'Actual',
            tl_ongoing: 'En curso',
