...
(() => {
    ...
    const I18N = {
        es: {
            ...
            hero_status: 'Málaga, España — Disponible para proyectos',
            hero_role: 'AI & Data Analyst',
            hero_dek: 'Llegué por el marketing y me quedé por los datos.',
            hero_sub: 'Analista digital en Paraty Tech, terminando un máster de Data Science e IA. Mi día a día va de medir bien, hacer buenas preguntas y conseguir que los datos acaben en decisiones, no en un PDF que nadie abre.',
            ...
            tl_bigschool_text: '400h para formalizar el salto a Data Science. Machine Learning, Explainable AI, Python, SQL, Tableau y analítica en cloud aplicados a proyectos reales. El puente del mundo analyst al scientist, esta vez construido en piedra.',
            tl_current: 'Actual',
            tl_ongoing: 'En curso',
            ph_taco_grupo: 'El equipo de Taco Bell en mi despedida',
            ph_taco_palmera: 'La palmera de chocolate que me regaló el equipo al despedirme',
            ph_windup: 'Grabando contenido para el Instagram de Windup',
            ph_talent_speech: 'Hablando con el micro frente a los finalistas de TalentLab Málaga',
            ph_talent_comida: 'Con otros finalistas en la comida del evento TalentLab',
            ph_paraty_reunion: 'Reunión de equipo en las oficinas de Paraty Tech',
            ph_paraty_grupo: 'Parte del equipo de Paraty Tech',
            ...
            footer_updated: 'Última actualización: jun 2026',
        ...
        en: {
            ...
            hero_status: 'Málaga, Spain — Available for projects',
            hero_role: 'AI & Data Analyst',
            hero_dek: 'Came for the marketing, stayed for the data.',
            hero_sub: "Digital analyst at Paraty Tech, finishing a master's in Data Science & AI. My days are about measuring things right, asking good questions and getting data to end up in decisions, not in a PDF nobody opens.",
            ...
            tl_talent_text: "Selected among the 25 finalists of a three-day intensive program run by FYCMA and Diario SUR, connecting Málaga's young talent with the region's leading companies through dynamics, panels and networking.",
            ...
            tl_bigschool_text: 'A 400h master to formalize the jump into Data Science. Machine Learning, Explainable AI, Python, SQL, Tableau and cloud analytics applied to real projects. The bridge from analyst to scientist, this time built in stone.',
            tl_current: 'Current',
            tl_ongoing: 'In progress',
            ph_taco_grupo: 'The Taco Bell team at my farewell',
            ph_taco_palmera: 'The chocolate farewell cake the team gave me',
            ph_windup: "Recording content for Windup's Instagram",
            ph_talent_speech: 'Speaking in front of the TalentLab Málaga finalists',
            ph_talent_comida: 'With other finalists at the TalentLab event lunch',
            ph_paraty_reunion: 'Team meeting at the Paraty Tech office',
            ph_paraty_grupo: 'Part of the Paraty Tech team',
            ...
            footer_updated: 'Last updated: Jun 2026',
